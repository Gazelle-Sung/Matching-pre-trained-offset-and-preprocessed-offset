...
3. Downlaod the pretrained glove word embeddings: https://nlp.stanford.edu/projects/glove/
4. Convert the pretrained glove word embeddings(txt) to pickle file format using Glove_txt2pkl.py
